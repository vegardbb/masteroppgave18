\begin{lstlisting}[language=Java, caption={Metoden \emph{addTransformer}, og metoden \emph{aggregateTransformerReceiver}, som kjøres i en separat tråd idet \textbf{Migrator}-konstruktøren kalles.}]
