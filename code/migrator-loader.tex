\begin{lstlisting}[language=Java, caption={Indre klasse brukt til å definere en transformasjonsklasse som arver konstruktør fra \emph{AbstractAggregateTransformer}.}]
